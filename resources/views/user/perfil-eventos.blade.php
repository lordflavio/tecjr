                                                            ...
                                                            <div class="media-body fnt-smaller">
                                                               ...
                                                               <p>
                                                                   <a style="text-decoration: none">
                                                                       <button class="btn btn-success p-buuton"> Inscrever-se nas Atividades </button>
                                                                   </a>

                                                                   <a style="text-decoration: none">
                                                                       <button class="btn btn-success p-buuton"> Atividades Escolhidas </button>
                                                                   </a>

                                                                   <a style="text-decoration: none">
                                                                       <button class="btn btn-success p-buuton"> Atividades do Evento  </button>
                                                                   </a>
                                                               </p>
