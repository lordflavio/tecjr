                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form id="payment_form">
                                ...
                                <input style="display: none" type="text" name="busca" id="curso"
                                       value="{{$evento->nome}}">
                                <input style="display: none" type="text" name="type" id="typo" value="2">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="card_holder_name"
                                               id="card_holder_name" placeholder="JOSE CAVALCANTE F SILVA"
                                               required/>
                                    </div>
                                </div>
                                <label class="text-left">Data de expiração</label>
                                <div class="form-group">
                                    <div class="col-xs-3 col-lg-3 pl-ziro">
                                        <label class="text-left">Mês</label>
                                        <input type="text" class="form-control" name="card_expiration_month"
                                               id="card_expiration_month" placeholder="Ex:12" required/>
                                    </div>
                                    <div class="col-xs-3 col-lg-3 ">
                                        <label class="text-left">Ano</label>
                                        {{--<input type="text" class="form-control" name="card_expiration_year" id="card_expiration_year" placeholder="Ex:2035" required />--}}

                                        <select class="form-control" id="card_expiration_year"
                                    ...
                                    <div class="col-xs-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="card_cvv" id="card_cvv"
                                ...
                                <div class="form-group col-xs-6 col-md-6 ">
                                    ...
                                    <input type="text" name="cpf" class="form-control " maxlength="15"
                                           placeholder="111.111.111.11" id="cpf" required="">

                                </div>

                                <div class="form-group col-xs-6 col-md-6 ">
                                    <label class="text-center">Data de Nascimento</label>
                                    <input type="text" name="data" class="form-control " maxlength="15" id="data"
...
<script>
    ...
    function getInstallments() {
        ...
        PagSeguroDirectPayment.getInstallments({
            amount: {{str_replace(",", ".", $evento->valor_inscricao)}}, // Total do carrinho $$
    ...
    function createCardToken() {
        PagSeguroDirectPayment.createCardToken({
            ...
            expirationYear: $('select[name=card_expiration_year]').val(), // Ano de expiração
            success: function (response) {
